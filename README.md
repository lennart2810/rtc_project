...
### Navigationsziele setzen (Steuerung mit Controller)
   ```sh
   roslaunch rtc_project set_navigation_points.launch points_via_robot:=false gazebo:=true controller_layout:=2 map_file:=/home/lennart/catkin_ws/src/rtc_project/maps/default_map.yaml
   ```
